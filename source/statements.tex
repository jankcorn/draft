...
\nontermdef{statement}\br
    ...
    \textbf{rule-statement}\br

\nontermdef{\textbf{rule-statement}}\br
    \textbf{\terminal{__rule} name \opt{if-guard} compound-statement}\br

\nontermdef{\textbf{if-guard}}\br
    \textbf{\terminal{if (} condition \terminal{)}}
