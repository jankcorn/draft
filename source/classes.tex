...
\nontermdef{class-key}\br
    ...
    \terminal{struct}\br
    \terminal{union}\br
    \terminal{\textbf{__interface}}\br
    \terminal{\textbf{__emodule}}\br
    \terminal{\textbf{__module}}
\end{bnf}
...
\nontermdef{member-declaration}\br
    \opt{attribute-specifier-seq} \textbf{\opt{pin-type}} \opt{decl-specifier-seq} \opt{member-declarator-list} \terminal{;}\br
    ...
    \textbf{connect-declaration}\br
    \textbf{forward-declaration}\br
    \textbf{printf-declaration}\br
    empty-declaration
\end{bnf}

\begin{bnf}
\nontermdef{\textbf{pin-type}}\br
    \textbf{__input}\br
    \textbf{__output}\br
    \textbf{__inout}\br
    \textbf{__parameter}
...
\begin{bnf}
\nontermdef{\textbf{connect-declaration}}\br
    \textbf{\terminal{__connect} identifier \terminal{=} identifier \terminal{;}}
\end{bnf}

\begin{bnf}
\nontermdef{\textbf{forward-declaration}}\br
    \textbf{\terminal{__forward} identifier \terminal{=} identifier \terminal{;}}
\end{bnf}

\begin{bnf}
\nontermdef{\textbf{printf-declaration}}\br
    \textbf{__printf \terminal{;}}
\end{bnf}
