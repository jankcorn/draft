...
\nontermdef{simple-type-specifier}\br
    ...
    \terminal{void}\br
    \terminal{auto}\br
    \terminal{\textbf{__uint \terminal{(} constant-expression \terminal{)} }}\br
    \terminal{\textbf{__int \terminal{(} constant-expression \terminal{)} }}\br
    decltype-specifier
\end{bnf}
...
\nontermdef{function-definition}\br
    \textbf{\opt{decl-specifier-seq} interface-qualifier-seq identifier parameters-and-qualifiers function-body}\br
...
\begin{bnf}
\nontermdef{\textbf{interface-qualifier}}\br
    \textbf{identifier \terminal{.}}

\nontermdef{\textbf{interface-qualifier-seq}}\br
    \textbf{interface-qualifier}\br
    \textbf{interface-qualifier-seq interface-qualifier}
\end{bnf}

\begin{bnf}
\nontermdef{function-body}\br
    \opt{ctor-initializer} \textbf{\opt{if-guard}} compound-statement\br
