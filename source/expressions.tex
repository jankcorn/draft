...
other type is ``pointer to \cvqual{cv2} T'',
...
\rSec3[expr.pseudo]{Pseudo destructor call}
...
is required to refer to the same declaration\iref{basic.scope.class}.
\end{note}
...
or invocation of an assignment operator\iref{class.copy.assign}
